...
**2026.04.10**
 - Added support for the module to properly inherit the Light/Dark modes in foundry system settings.  CSS is the devil.
 - Added optional announcements to chat when new effects are added to the effect tracker
 - Added effect icons to chat cards
